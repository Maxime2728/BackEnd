...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 30 juin 2022 à 08:20
...
CREATE TABLE `t_d_dossiersav_sav` (
  `SAV_ID` int(11) NOT NULL,
  `SAV_NUM_DOSSIER` varchar(255) NOT NULL,
...
(4, NULL, 'gdelacroix@hotmail.fr', 'b70f7d0e2acef2e0fa1c6f117e3c11e0d7082232', 'Guillaume', 'Delacroix', 2),
...
(17, NULL, 'bizeaumaxime78@gmail.com', '805872c82fbc88ba7003475dd990666079e22a35', 'Maxime', 'Bizeau', 2),
...
--
ALTER TABLE `t_d_address_adr`
  MODIFY `ADR_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `t_d_orderdetails_odt`
  MODIFY `OHR_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
