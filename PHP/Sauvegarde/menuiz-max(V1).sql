...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 27 juin 2022 à 13:36
...
CREATE TABLE `t_d_dossiersav_sav` (
  `SAV_ID` int(255) NOT NULL,
  `SAV_NUM_DOSSIER` int(255) DEFAULT NULL,
  `SAV_TYPE` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(28, 2, 'bizeaumaxime78@gmail.com', '805872c82fbc88ba7003475dd990666079e22a35', 'Maxime', 'Bizeau', 'Thomas Campanelli', 1);
...
ALTER TABLE `t_d_detailsav_dsv`
  ...
  ADD CONSTRAINT `t_d_detailsav_dsv_ibfk_2` FOREIGN KEY (`PTY_ID`) REFERENCES `t_d_producttype_pty` (`PTY_ID`);
