...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 28 juin 2022 à 08:14
...
CREATE TABLE `t_d_dossiersav_sav` (
  `SAV_ID` int(11) NOT NULL,
  `SAV_NUM_DOSSIER` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `t_d_dossiersav_sav` (`SAV_ID`, `SAV_NUM_DOSSIER`) VALUES
(0, 5968498);
...
(17, NULL, 'bizeaumaxime78@gmail.com', '805872c82fbc88ba7003475dd990666079e22a35', 'Bizeau', 'Maxime', 2);
