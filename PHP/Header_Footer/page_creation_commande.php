...
require __DIR__ . '/Model/ModelTypePaiement.php';
require __DIR__ . '/Model/ModelExpeditionType.php';
require __DIR__ . '/Model/ModelAdresse.php';
require __DIR__ . '/Model/ModelExpedition.php';
require __DIR__ . '/Model/ModelOrderHeader.php';
require __DIR__ . '/Model/ModelOrderDetail.php';
...
$typepaiement = new ModeleTypePayment();
...
$adresses = $adrm->RecupAddressByUser($_SESSION['prenom_nom']['id'])->fetchAll();
