...
<head>
  ...
  <title>Conduite Accompagnée - Auto École Simiane</title>
...
<body>
  ...
  <div class="d-flex center">
    ...
    <div class="card" style="width: 30%;">
      <div class="card-body">
        <h5 class="card-title">Comment réussir ma Conduite Accompagnée ?</h5>
        ...
        <a href="#" class="card-link btn btn-bleu">Qu-est ce que c'est la Conduite Accompagnée ?</a>
        <a href="#" class="card-link btn btn-rouge">Je veux passer ma Conduite Accompagnée !</a>
      </div>
    </div>
