...
<head>
  ...
  <title>Conduite Supervisée - Auto École Simiane</title>
...
<body>
  ...
  <div class="section-picture">
    <img src="images/aes-conduite-supervisee.png" alt="Pilon du Roy" width="100%">
    <div class="container container-fixed">
      ...
      <div class="col col-md-3 ident-page">
        <!-- <h3 class="text-pilon">Conduite Supervisée</h3> -->
      </div>
    </div>
  </div>
  ...
  <div class="d-flex center">
    ...
    <div class="card" style="width: 30%;">
      <div class="card-body">
        <h5 class="card-title">Comment réussir ma Conduite Supervisée ?</h5>
        ...
        <a href="#" class="card-link btn btn-bleu">Qu-est ce que c'est le code ?</a>
        <a href="#" class="card-link btn btn-rouge">Je veux passer mon code !</a>
      </div>
    </div>
